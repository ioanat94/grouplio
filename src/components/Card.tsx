...
function Card(person) {
  return (
    <div className='card flex flex-col items-center justify-evenly gap-8 border-2 border-solid border-teal-900 rounded-lg w-72 h-80 shadow-xl py-2 md:transition-all md:hover:bg-white md:hover:shadow-none'>
